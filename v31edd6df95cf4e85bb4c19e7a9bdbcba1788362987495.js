( () => {
    var t = {
            ...
            !function(t) {
                ...
                class e {
                    ...
                    l(t) {
                        ...
                        const e = this.i[0]
                          , n = this.i.at(-1);
                        this.o && e && n && t.startTime - n.startTime < 1e3 && t.startTime - e.startTime < 5e3 ? (this.o += t.value,
                        this.i.push(t)) : (this.o = t.value,
                        this.i = [t]),
                        this.t?.(t)
                    }
                }
                ...
                function s(t, e) {
                    let n = a.get(e);
                    return n || (n = new WeakMap,
                    a.set(e, n)),
                    n.get(t) || n.set(t, new e),
                    n.get(t)
                }
                let c = -1;
                const l = () => c
                  ...
                  , u = (t, e, n, i) => {
                    let o, r;
                    return a => {
                        e.value >= 0 && (a || i) && (r = e.value - (o ?? 0),
                        (r || void 0 === o) && (o = e.value,
                        e.delta = r,
                        ...
                        if (i.length > 0) {
                            const t = new PerformanceObserver(t => {
                                queueMicrotask( () => {
                                    ...
                                    i.length > 1 && n.sort( (t, e) => t.startTime + t.duration - (e.startTime + e.duration)),
                                    e(n)
                                }
                                )
                            }
                ...
                const P = t => {
                  ...
                  , L = (t, e={}) => {
                    ...
                    P( () => {
                        ...
                        const c = S(["paint"], t => {
                            for (const e of t)
                                "first-contentful-paint" === e.name && (c.disconnect(),
                                e.startTime < o.firstHiddenTime && (a.value = Math.max(e.startTime - g(), 0),
                                a.entries.push(e),
                                a.navigationId = e.navigationId || a.navigationId,
                                r(!0)))
                        }
                        );
                        c && (r = u(t, a, x, e.reportAllChanges),
                        d(n => {
                            a = T("FCP", -1, "back-forward-cache", a.navigationId, a.navigationInteractionId, a.navigationURL, l()),
                        ...
                        n && S(["soft-navigation"], n => {
                            n.forEach(n => {
                                ...
                                a = T("FCP", o, "soft-navigation", n.navigationId, n.interactionId, n.name, n.startTime),
                                r = u(t, a, x, e.reportAllChanges),
                                r(!0)
                            }
                            )
                ...
                class B {
                    ...
                    l(t) {
                        ...
                        if (n || this.p.length < 10 || t.duration > e.k) {
                            if (n ? t.duration > n.k ? (n.entries = [t],
                            n.k = t.duration) : t.duration === n.k && t.startTime === n.entries[0].startTime && n.entries.push(t) : (n = {
                                id: t.interactionId,
                                entries: [t],
                                k: t.duration
                            },
                    ...
                    ( (t, n={}) => {
                        ...
                        L(E( () => {
                            ...
                            const a = s(n, e)
                              ...
                              , g = (t=!1) => {
                                a.o > r.value && (r.value = a.o,
                                r.entries = a.i),
                                o(t)
                            }
                              , p = t => {
                                g(!0),
                                c("soft-navigation", t.navigationId, t.interactionId, t.name, t.startTime)
                            }
                              , v = t => {
                                for (const e of t)
                            ...
                            const y = S(m, v);
                            y && (o = u(t, r, C, n.reportAllChanges),
                            i.onHidden( () => {
                                v(y.takeRecords()),
                                o(!0)
                            }
                            ...
                            d( () => {
                                c("back-forward-cache", r.navigationId, r.navigationInteractionId, r.navigationURL, l()),
                                f(o)
                            }
                            ),
                            setTimeout(o))
                ...
                t.onINP = (t, e={}) => {
                    ...
                    const v = () => {
                      ...
                      , m = () => {
                        ...
                        o = o.filter(t => t.startTime > c || i.has(t)),
                        p = !1
                    }
                    ;
                    n.m = t => {
                        ...
                        P( () => {
                            ...
                            const r = s(e, B)
                              ...
                              , f = t => {
                                c(),
                                i(!0),
                                a("soft-navigation", t.navigationId, t.interactionId, t.name, t.startTime)
                            }
                              , g = (t, e=!1) => {
                                F( () => {
                                    for (const e of t)
                        ...
                        t((t => {
                            ...
                            return (t => {
                                const e = t.interactionTime
                                  , n = t.nextPaintTime;
                                if (!t.longAnimationFrameEntries?.length || !e || !n)
                                    return;
                                const i = t.inputDelay
                                  , o = t.processingDuration;
                                let r, a, s = 0, c = 0, l = 0, d = 0;
                                for (const n of t.longAnimationFrameEntries) {
                                    ...
                                    for (const t of n.scripts) {
                                        ...
                                        s += l - u,
                                        c += u,
                                        l > d && (a = t.startTime < e + i ? "input-delay" : t.startTime >= e + i + o ? "presentation-delay" : "processing-duration",
                                        r = t,
                                        d = l)
                                    }
                                }
                    ...
                    ( (t, e={}) => {
                        ...
                        P( () => {
                            ...
                            const c = s(e, _)
                              ...
                              , v = t => {
                                ...
                                n || o(!0),
                                p("soft-navigation", t.navigationId, t.interactionId, t.name, t.startTime);
                              ...
                              , m = t => {
                                ...
                                for (const e of t) {
                                    ...
                                    if ("largest-contentful-paint" === e.entryType)
                                        ...
                                        if (!a.navigationId)
                                            continue;
                                        if ("interactionId" in o && o.interactionId != a.navigationInteractionId)
                                            continue;
                                        i = o.largestContentfulPaint?.renderTime || 0,
                                        t = Math.max(i - e.startTime, 0),
                                        o.largestContentfulPaint && (c.l(o.largestContentfulPaint),
                                        n = [o.largestContentfulPaint])
                                    }
                                    i < r.firstHiddenTime && (a.value = t,
                                    a.entries = n,
                                    o())
                                }
                            }
                            ...
                            if (b) {
                                ...
                                d(i => {
                                    p("back-forward-cache", a.navigationId, a.navigationInteractionId, a.navigationURL, l()),
                                    o = u(t, a, H, e.reportAllChanges),
                                    f( () => {
                        ...
                        t((t => {
                            ...
                            if (t.entries.length) {
                                ...
                                let c = 0
                                  , l = 0;
                                if ("soft-navigation" !== t.navigationType ? (s = n(),
                                c = s?.activationStart ?? 0,
                                l = s?.responseStart ?? 0) : (c = t.navigationStartTime || 0,
                    ...
                    ( (t, e={}) => {
                        ...
                        q( () => {
                            ...
                            if (a) {
                                ...
                                r(!0),
                                d( () => {
                                    o = T("TTFB", 0, "back-forward-cache", o.navigationId, o.navigationInteractionId, o.navigationURL, l()),
                                    r = u(t, o, W, e.reportAllChanges),
                                    r(!0)
                                }
                                ),
                                i && S(["soft-navigation"], n => {
                                    n.forEach(n => {
                                        n.navigationId && (o = T("TTFB", 0, "soft-navigation", n.navigationId, n.interactionId, n.name, n.startTime),
                                        o.entries = [n],
                                        r = u(t, o, W, e.reportAllChanges),
                                        r(!0))
                                    }
        ...
        674: (t, e) => {
            ...
            e.buildTimingsObject = function(t, n, i, o) {
                if (void 0 !== n)
                    for (const r of i) {
                        const i = t[r];
                        if ("number" == typeof i) {
                            if (e.positiveOnlyFields.has(r) && i <= o)
                                continue;
                            n[r] = Math.ceil(i)
                        } else
            ...
            ,
            e.timingsTargetKeys = ["navigationStart", "domainLookupStart", "domainLookupEnd", "connectStart", "connectEnd", "secureConnectionStart", "redirectStart", "redirectEnd", "requestStart", "responseStart", "responseEnd", "domLoading", "domComplete", "loadEventStart", "loadEventEnd"],
    ...
    ( () => {
        ...
        ( () => {
            function n(t) {
                let e = "";
                if (e = window.location.origin ? window.location.origin : `${window.location.protocol}//${window.location.host}`,
                t && "string" == typeof t)
                    if (0 === t.indexOf("/"))
                        e += t;
                    else
            ...
            !function() {
                ...
                const y = function(e) {
                    let n = e;
                    return null == n || "true" === n || !0 === n ? t.SpaMonitoringType.HistoryAndNavigationAPI : "false" === n || !1 === n ? t.SpaMonitoringType.None : ("string" == typeof n && (n = parseInt(n, 10)),
                    "number" == typeof n && n >= t.SpaMonitoringType.None && n <= t.SpaMonitoringType.SoftNavigationHeuristics ? n : t.SpaMonitoringType.HistoryAndNavigationAPI)
                }(v.spa)
                ...
                function N(t) {
                    ...
                    case "CLS":
                        l = t.attribution,
                        l && k.cls && (k.cls.element = l.largestShiftTarget,
                        k.cls.currentRect = null === (e = l.largestShiftSource) || void 0 === e ? void 0 : e.currentRect,
                        k.cls.previousRect = null === (n = l.largestShiftSource) || void 0 === n ? void 0 : n.previousRect);
                        break;
                    case "LCP":
                        l = t.attribution,
                        l && k.lcp && (k.lcp.element = l.target,
                        ...
                        k.lcp.it = null === (o = l.lcpResourceEntry) || void 0 === o ? void 0 : o.initiatorType,
                        k.lcp.fp = null === (a = null === (r = l.lcpEntry) || void 0 === r ? void 0 : r.element) || void 0 === a ? void 0 : a.getAttribute("fetchpriority"));
                        break;
                    case "INP":
                        ...
                        l = t.attribution,
                        l && k.inp && (k.inp.element = l.interactionTarget,
                ...
                "PerformanceObserver" in window && "function" == typeof PerformanceObserver && PerformanceObserver.supportedEntryTypes && ((0,
                i.onLCP)(N, {
                    reportAllChanges: !0,
                    reportSoftNavs: !0
                }),
                ...
                (0,
                i.onTTFB)(N),
                PerformanceObserver.supportedEntryTypes && -1 !== PerformanceObserver.supportedEntryTypes.indexOf("layout-shift") && (0,
                i.onCLS)(N, {
                    reportAllChanges: !0,
                    reportSoftNavs: !0
                })),
                document.addEventListener("visibilitychange", () => {
                    if ("hidden" === document.visibilityState) {
                        if (h && F()) {
                            const t = n();
                            (null == M ? void 0 : M.url) == t && (null == M ? void 0 : M.triggered) || D(),
                            p(t)
                        }
                        !A && M && (A = !0,
                        R())
                ...
                const D = i => {
                        ...
                        if (o) {
                            if ("function" == typeof s.getEntriesByType) {
                                ...
                                if (t && Array.isArray(t) && t.length > 0) {
                                    ...
                                    const e = t[0];
                                    (0,
                                    r.buildTimingsObject)(e, l.timingsV2, r.timingsV2TargetKeys, e.startTime)
                                }
                            }
                            if (1 === l.versions.timings) {
                                const t = a;
                                l.timings && (0,
                                r.buildTimingsObject)(t, l.timings, r.timingsTargetKeys, t.navigationStart)
                            }
                    ...
                    o && v && v && ((0,
                    e.sendObjectBeacon)("", o, () => {}
                    , !1, b),
                    void 0 !== v.forward && void 0 !== v.forward.url && (0,
                    e.sendObjectBeacon)("", o, () => {}
                    , !1, v.forward.url))
                }
                  , R = n => {
                    let i = function(e) {
                        ...
                        return v && (v.version && (n.versions.fl = v.version),
                        v.icTag && (n.icTag = v.icTag),
                        n.siteToken = v.token),
                        k && d.forEach(t => {
                            k[t] && void 0 !== k[t].value && (n[t] = k[t],
                            n[t] && n[t].value && (n[t].value = (0,
                            a.roundWebVitalValue)(t, n[t].value)))
                        }
                        ),
                        n
                    }(n);
                ...
                function U(t) {
                    ...
                    if (t) {
                        ...
                        if (n)
                            return Math.ceil(s.timeOrigin + n)
                    }
                ...
                h && (y === t.SpaMonitoringType.SoftNavigationHeuristics && (T = function() {
                    var e, n;
                    if (!("PerformanceObserver" in window) || !PerformanceObserver.supportedEntryTypes || -1 === PerformanceObserver.supportedEntryTypes.indexOf("soft-navigation"))
                        return null;
                    if ("function" != typeof (null === (n = null === (e = window.PerformanceSoftNavigation) || void 0 === e ? void 0 : e.prototype) || void 0 === n ? void 0 : n.getLargestInteractionContentfulPaint))
                        return null;
                ...
                T || y !== t.SpaMonitoringType.HistoryAndNavigationAPI && y !== t.SpaMonitoringType.SoftNavigationHeuristics || (S = function() {
                    ...
                    let e = function(e) {
                        var n, i;
                        e.canIntercept && (R(m),
                        !e.destination || "boolean" != typeof e.destination.sameDocument || e.destination.sameDocument ? (j(),
                        m = null !== (i = null === (n = null == e ? void 0 : e.destination) || void 0 === n ? void 0 : n.url) && void 0 !== i ? i : m,
                        p(m, {
                            navigationType: t.NavigationType.RoutingApis
                        }),
                        D(m)) : A = !0)
                    };
                    return window.navigation.addEventListener("navigate", e),
                    e
                }(),
                S || (_ = window.history,
                (H = _.pushState) && (_.pushState = function(e, i, o) {
                    const r = n(o);
                    return m != r && (R(m),
                    j(),
                    p(r, {
                ...
                function z(e, i) {
                    const o = K(u)
                      ...
                      , s = {
                        ...
                        bi: (c = C,
                        c.bv || c.ov || c.be || c.bev ? C : void 0)
                    };
                    var c;
                    return S && s.nt === t.NavigationType.RoutingApis && (s.ntapi = 1),
                    s
                }
                function J(t) {
                    var e;
                    if ("first-contentful-paint" === t && k.fcp && k.fcp.value)
                        return Math.ceil(k.fcp.value);
                    if ("function" == typeof s.getEntriesByType) {
